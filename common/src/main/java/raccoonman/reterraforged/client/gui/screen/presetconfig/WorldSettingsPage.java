...
public class WorldSettingsPage extends PresetEditorPage {
	...
	public void init() {
		...
		this.oceanDepth = PresetWidgets.createIntSlider(properties.oceanDepth, 0, 160, RTFTranslationKeys.GUI_SLIDER_OCEAN_DEPTH, (slider, value) -> {
			properties.oceanDepth = (int) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
