...
public final class RTFTranslationKeys {
	...
	public static final String GUI_FAKE_WATER_BIOME_SETTINGS_TITLE = resolve("gui.fakeWaterBiomeSettings.title");
	...
	public static final String GUI_BUTTON_ENABLE_FAKE_WATER_BIOMES = resolve("gui.button.enableFakeWaterBiomes");
	...
	public static final String GUI_SLIDER_FAKE_WATER_HEIGHT_OFFSET = resolve("gui.slider.fakeWaterHeightOffset");
	...
	public static final String GUI_LABEL_FAKE_WATER_BIOMES = resolve("gui.label.fakeWaterBiomes");
