...
public final class RTFLanguageProvider {
	...
	public static final class EnglishUS extends LanguageProvider {
		...
		protected void addTranslations() {
			...
			this.add(RTFTranslationKeys.GUI_FAKE_WATER_BIOME_SETTINGS_TITLE, "Fake Water Biomes");
			...
			this.add(RTFTranslationKeys.GUI_BUTTON_ENABLE_ARCHIPELAGO, "Enable Archipelago");
			this.add(RTFTranslationKeys.GUI_BUTTON_ENABLE_FAKE_WATER_BIOMES, "Fake Water Biomes");
			this.add(RTFTranslationKeys.GUI_BUTTON_STEPPE_FAKE_RIVERS, "Steppe Fake Rivers");
			this.add(RTFTranslationKeys.GUI_BUTTON_BADLANDS_FAKE_OCEANS, "Badlands Fake Rivers");
			...
			this.add(RTFTranslationKeys.GUI_SLIDER_OCEAN_DEPTH, "Deep Ocean Depth");
			...
			this.add(RTFTranslationKeys.GUI_SLIDER_ISLAND_DENSITY, "Island Density");
			this.add(RTFTranslationKeys.GUI_SLIDER_ISLAND_SIZE, "Island Size");
			this.add(RTFTranslationKeys.GUI_SLIDER_ISLAND_HEIGHT, "Island Height");
			this.add(RTFTranslationKeys.GUI_SLIDER_ISLAND_BASE_SCALE, "Base Scale");
			this.add(RTFTranslationKeys.GUI_SLIDER_ISLAND_VERTICAL_SCALE, "Vertical Scale");
			this.add(RTFTranslationKeys.GUI_SLIDER_ISLAND_HORIZONTAL_SCALE, "Horizontal Scale");
			this.add(RTFTranslationKeys.GUI_SLIDER_ISLAND_MOUNTAIN_CHANCE, "Mountain Chance");
			this.add(RTFTranslationKeys.GUI_SLIDER_ISLAND_VOLCANO_CHANCE, "Volcano Chance");
			this.add(RTFTranslationKeys.GUI_SLIDER_ISLAND_OFFSHORE_DEPTH, "Offshore Depth");
			this.add(RTFTranslationKeys.GUI_SLIDER_ISLAND_BEACH_WIDTH, "Beach Width");
			this.add(RTFTranslationKeys.GUI_SLIDER_ISLAND_BEACH_COVERAGE, "Beach Coverage");
			this.add(RTFTranslationKeys.GUI_SLIDER_FAKE_WATER_HEIGHT_OFFSET, "Height Offset");
			...
			this.add(RTFTranslationKeys.GUI_LABEL_ISLAND, "Island");
			this.add(RTFTranslationKeys.GUI_LABEL_FAKE_WATER_BIOMES, "Fake Water Biomes");
			...
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_BUTTON_CAVE_DENSITY_ALGORITHM), "LEGACY keeps the original cave density graph. LEGACY_V2 is the default, preserves that graph, and reuses exact repeated samples. QUICK_V1 is the optional quick-noise algorithm. OpenCL is separately opt-in and disabled by default.");
			...
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_BUTTON_ENABLE_ARCHIPELAGO), "Generate archipelago islands in ocean and coastal regions.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_BUTTON_ENABLE_FAKE_WATER_BIOMES), "Allow below-sea-level dry terrain to request water biomes.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_BUTTON_STEPPE_FAKE_RIVERS), "Treat below-sea-level steppe terrain as river biome terrain.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_BUTTON_BADLANDS_FAKE_OCEANS), "Treat below-sea-level badlands terrain as river biome terrain.");
			...
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_OCEAN_DEPTH), "Controls deep ocean floor depth. The default preserves the existing generator scale and does not change sea level or coastline transition points.");
			...
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_ISLAND_DENSITY), "Controls how frequently archipelago islands appear.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_ISLAND_SIZE), "Controls the horizontal size of individual archipelago islands.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_ISLAND_HEIGHT), "Controls the overall height of archipelago islands.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_ISLAND_BASE_SCALE), "Controls the base height of island land.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_ISLAND_VERTICAL_SCALE), "Controls island mountain and hill relief.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_ISLAND_HORIZONTAL_SCALE), "Controls the horizontal scale of island terrain noise.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_ISLAND_MOUNTAIN_CHANCE), "Controls the chance for islands to contain mountains.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_ISLAND_VOLCANO_CHANCE), "Controls the chance for islands to contain volcano-shaped peaks.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_ISLAND_OFFSHORE_DEPTH), "Controls how deep water shelves are around islands.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_ISLAND_BEACH_WIDTH), "Controls the width of island beaches.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_ISLAND_BEACH_COVERAGE), "Controls how much island edge area becomes beach.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_FAKE_WATER_HEIGHT_OFFSET), "Controls how far below sea level terrain must be before fake-water biome mapping applies.");
